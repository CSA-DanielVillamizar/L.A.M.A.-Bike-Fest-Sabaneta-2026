...
export const CHAPTERS_BY_COUNTRY: Record<string, string[]> = {
    ...
    "Brasil": ["Anápolis", "Aparecida", "Goiania", "Maricá", "Rio de Janeiro"],
    ...
    "Cuba": ["Camaguey", "Cárdenas", "Cienfuegos", "Clásicos de Cuba", "Clásicos Las Tunas", "Cuba National Committee", "Guardalavaca", "Habana", "Holguín", "Kuban Bikers", "Matanzas", "Sancti Spiritus", "Santa Clara", "Santiago de Cuba", "Trinidad"],
    "Alemania": ["Breakout", "Christophorus", "Donautal", "Neckar District", "Riverside"],
    ...
    "USA": ["Addison", "Alburquerque", "Allentown", "Annapolis", "Athens", "Atlanta", "Atlanta South", "Austin", "Baltimore", "Bethlehem", "Blackwood", "Bloomington", "Boca Raton", "Brandon", "Bristol", "Buffalo", "Chicago", "Chicago South", "Chicago West", "Cicero", "Cincinnati", "Clermont", "Corpus Christi", "Dallas", "Daytona Beach", "Deltona", "Detroit", "East Hartford", "Elgin", "Empire State", "Flagstaff", "Fredericksburg", "Fort Lauderdale", "Fort Myers", "Fort Worth", "Gaithersburg", "Gilbert", "Harrisburg", "Holyoke", "Houston", "Inmortal Riders", "Jacksonville", "Jax Beach", "Keansburg", "Kissimmee", "Lakeside", "Lancaster", "Lawton / Fort Sill", "Lincoln Park", "Lorain", "Los Angeles", "Madison", "Manassas", "Manville", "Melbourne", "Mesquite", "Miami", "Midletown", "Midway", "Milwaukee", "Minneapolis", "Naples", "New York City", "Newark", "Norristown", "Northwest", "Ocala", "O´Hare", "OKC", "Orlando", "Palm Beach County", "Pennsauken", "Perth Amboy", "Phenix City", "Philadelphia", "Philipsburg", "Phoenix", "Poconos", "Poinciana", "Port Saint Lucie", "Queens", "Reading", "Rochester (MN)", "Rochester (NY)", "Rockford", "Rockwall", "San Antonio", "San José", "Savannah", "Sebring", "Springfield (MA)", "Springfield (MO)", "Saint Augustine", "Tampa", "Twin Cities", "Vineland", "Washington DC", "Will County", "Winfield", "Worcester"],
