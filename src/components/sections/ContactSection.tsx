            ...
            <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
                <div className="rounded-2xl border border-white/10 bg-black/35 p-6 sm:p-8">
                    <div className="grid gap-8 lg:grid-cols-[1.3fr_0.9fr]">
                                ...
                                {boardContacts.map((contact) => (
                                    ...
                                    >
                                        ...
                                        <Link
                                            ...
                                            target="_blank"
                                            rel="noreferrer"
                                            className="mt-2 inline-flex text-sm text-orange-300 transition hover:text-orange-200"
                                        >
                                            {contact.phone}
                                        </Link>
                                    </article>
                        ...
                        <aside className="rounded-xl border border-orange-500/30 bg-orange-500/10 p-5">
